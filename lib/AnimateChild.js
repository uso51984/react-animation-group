...
var _domAnimation = require('dom-animation');
...
var AnimateChild = function (_React$Component) {
  ...
  _createClass(AnimateChild, [{
    ...
    value: function componentWillAppear(done) {
      console.log('animUtil.isAppearSupported(this.props)', _animate2['default'].isAppearSupported(this.props));
    ...
    value: function transition(animationType, finishCallback) {
      ...
      console.log('props.animation[animationType]', props.animation[animationType]);
      if ((_domAnimation.isCssAnimationSupported || !props.animation[animationType]) && transitionName && props[transitionMap[animationType]]) {
        ...
        this.stopper = (0, _domAnimation2['default'])(node, {
          name: name,
          active: activeName
        }, end);
      } else {
